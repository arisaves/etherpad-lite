 ...
 *
 * @param  {String}    lowestNonDeprecatedNodeVersion
 * all Node version less than this one are deprecated
 * @param  {Function}  epRemovalVersion
 * Etherpad version that will remove support for deprecated Node releases
 */
