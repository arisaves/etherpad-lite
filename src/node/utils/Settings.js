...
console.log(`All relative paths will be interpreted relative
    to the identified Etherpad base dir: ${exports.root}`);
  ...
  if (!exports.sessionKey) {
    ...
    console.warn(`Declaring the sessionKey in the settings.json is deprecated.
      This value is auto-generated now. Please remove the setting from the file.
       -- If you are seeing this error after restarting using the
       Admin User Interface then you can ignore this message.`);
  }
